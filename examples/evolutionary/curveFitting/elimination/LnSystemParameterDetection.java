...
import function.prototype.LnFunction;
...
public class LnSystemParameterDetection {

	private LnSystemParameterDetection() {}
	
	public static void main(String[] args) throws IOException {
		
		int variableMinValue = -5;
		...
		graph.addFunction(
				new DimensionFocusWrapper(lnFunction, 0, new double[1])
		, Color.BLUE);
		...
		evaluator.addObserver(new BestObserver<>(decoder, Arrays.asList(
				...
				new PrototypeGraphngBestObserver<DoubleArraySolution>(lnFunction, graph),
