...
import function.prototype.TanFunction;
...
public class TanSystemParameterDetection {

	private TanSystemParameterDetection() {}
	...
	public static void main(String[] args) throws IOException {
		...
		graph.addFunction(				
				new DimensionFocusWrapper(tanFunction, 0, new double[1]),
			 Color.BLUE);
		...
		evaluator.addObserver(new BestObserver<>(decoder, Arrays.asList(
				...
				new PrototypeGraphngBestObserver<DoubleArraySolution>(tanFunction, graph),
