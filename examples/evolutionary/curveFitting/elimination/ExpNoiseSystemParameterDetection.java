...
public class ExpNoiseSystemParameterDetection {

	private ExpNoiseSystemParameterDetection() {}
	
	public static void main(String[] args) throws IOException {
		
		int variableMinValue = -5;
		int variableMaxValue = 5;
		...
		graph.addFunction(new DimensionFocusWrapper(expFunction, 0, new double[1])
		, Color.BLUE);
