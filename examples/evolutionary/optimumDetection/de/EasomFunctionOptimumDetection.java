...
import evolutionary.algorithm.de.baseVectorSelection.RandomBaseVectorSelection;
...
import evolutionary.algorithm.de.linearCombinationProvider.RandomLinearCombinationProvider;
...
public class EasomFunctionOptimumDetection {
	...
	public static void main(String[] args) {
		...
		IBaseVectorSelection<DoubleArraySolution> baseVectorSelection = new RandomBaseVectorSelection<>();
		
		//Linear combination provider
		IDeLinearCombinationProvider<DoubleArraySolution> linearCombinationProvider =  new RandomLinearCombinationProvider(linearCombinationCount);
